...
const BackToEarn = ({ myClass }) => {
  return (
    <>
      <div
        className={`max-lg:hidden relative min-h-[1190px] bg-[url(/assets/images/webp/back-to-earn-bg.webp)] bg-cover bg-no-repeat bg-center -z-10 ${myClass}`}
      >
      ...
      <div
        className={`lg:hidden w-full overflow-hidden relative min-h-[1112px] bg-[url(/assets/images/webp/back-to-earn-bg.webp)] bg-cover bg-no-repeat bg-center -z-10 flex-col flex justify-center items-center pt-32 -mt-28 ${myClass}`}
      >
